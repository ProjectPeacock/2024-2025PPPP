...
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_ARM_AVOID_POSITION;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_ARM_DEGREES_TO_SERVO;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_ARM_FINE_ADJUST_DEGREES_PER_SECOND;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_ARM_FINE_ADJUST_LOWER_BOUND;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_ARM_FINE_ADJUST_UPPER_BOUND;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_ARM_IN_POSITION;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_ARM_IN_TRANSFER_WAIT;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_ARM_OUT_POSITION;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_ARM_PRESET_SPEED;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_ARM_SERVO_TO_DEGREES;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_ARM_VERTICAL_POSITION;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_AVOID;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_CLAW_CLOSED;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_CLAW_CLOSE_TIME;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_CLAW_IN_OPEN;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_CLAW_OUT_OPEN;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_IN;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.INTAKE_OUT;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.LIFT_HIGH_PRESET_POSITION;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.LIFT_LOW_PRESET_POSITION;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.LIFT_MAX_POSITION;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.LIFT_MIDDLE_PRESET_POSITION;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.LIFT_TRANSFER_UPPER_LIMIT;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.MAX_OUTTAKE_ARM_OUT_IN_TIME;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTER_OUTTAKE_CLAW_CLOSED;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTER_OUTTAKE_CLAW_OPEN;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_ARM_DEGREES_TO_SERVO;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_ARM_DROP_POSITION;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_ARM_DROP_TIME;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_ARM_FINE_ADJUST_DEGREES_PER_SECOND;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_ARM_FINE_ADJUST_LOWER_BOUND;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_ARM_FINE_ADJUST_UPPER_BOUND;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_ARM_IN_POSITION;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.MIN_OUTTAKE_ARM_OUT_IN_TIME;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_ARM_OUT_POSITION;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_ARM_PRESET_SPEED;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_ARM_SERVO_TO_DEGREES;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_CLAW_CLOSE_TIME;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_CLAW_DROP_TIME;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_GOING_IN;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_GOING_OUT;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_IN;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_OUT;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_WAIT;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_WRIST_DEGREES_TO_SERVO;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_WRIST_FINE_ADJUST_DEGREES_PER_SECOND;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_WRIST_FINE_ADJUST_LOWER_BOUND;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_WRIST_FINE_ADJUST_UPPER_BOUND;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.OUTTAKE_WRIST_VERTICAL_OFFSET;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.PLANE_LAUNCHER_HOLD;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.PLANE_LAUNCHER_LAUNCH;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.RIGHT_INTAKE_ARM_OFFSET;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.RIGHT_OUTTAKE_ARM_OFFSET;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_CLAW_DELAY;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_DROPPING;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_DROP_TIME;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_GRAB;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_IDLE;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_INSTANT_OUT_DELAY;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_INTAKE_AVOID;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_INTAKE_AVOID_RUN_OUT;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_OUT;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_POSITIONING;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_PRESET_HOLD;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_RESET;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.TRANSFER_RESET_CLAW_DROP;
import static org.firstinspires.ftc.teamcode.competition.util.RobotConstants.liftPIDFCoefficients;
